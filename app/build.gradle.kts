...
android {
    ...
    buildTypes {
        release {
            ...
            // Disable dependency metadata for F-Droid reproducible builds
            dependenciesInfo {
                includeInApk = false
...
dependencies {
    ...
    implementation("net.java.dev.jna:jna:5.13.0@aar")  // JNA with Android native libraries
    ...
    // Kotlinx Serialization (for Room TypeConverters)
